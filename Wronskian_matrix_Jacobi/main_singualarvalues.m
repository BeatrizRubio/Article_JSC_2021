...
%Bidiagonal decomposition of the Wronskian matrix of Jacobi polynomials presented in  
...
%Experimental results in Mathematica: WronskianJacobi_Singularvalues.nb
...
SVM=min(svd(W));
dlmwrite('SVWronskian_JacobiB.csv',SVB,'precision','%.45f');
dlmwrite('SVWronskian_JacobiM.csv',SVM,'precision','%.45f');
