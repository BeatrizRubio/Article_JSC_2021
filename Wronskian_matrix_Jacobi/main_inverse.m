...
%Experimental results in Mathematica: Wronskian_Jacobi_inverse.nb
...
IM=inv(W);
dlmwrite('inverseWronskianJacobiB.csv',IB,'precision','%.45f');
dlmwrite('inverseWronskianJacobiM.csv',IM,'precision','%.45f');
